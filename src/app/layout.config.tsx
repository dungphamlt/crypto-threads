...
export const baseOptions = {
  ...
  links: [
    ...
    },
    {
      ...
      active: "nested-url",
      dropdown: [
        { text: "TradFi", url: "/insights/tradfi" },
        { text: "Regulations", url: "/insights/regulations" },
        { text: "Markets", url: "/insights/markets" },
      ],
    },
    {
      type: "main",
    ...
    },
    {
      ...
      active: "nested-url",
      dropdown: [
        { text: "Trading Strategies", url: "/trading/trading-strategies" },
